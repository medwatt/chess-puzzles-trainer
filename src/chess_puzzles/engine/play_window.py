...
class EnginePlayWindow(tk.Toplevel):
    ...
    def _on_user_move(self, move: chess.Move, *, animate: bool = True) -> None:
        ...
        if accepted is None:
            ...
            self.status_var.set("Illegal move." if self.session.is_human_turn else "Waiting for the engine.")
            return
    ...
    def _schedule_engine_move(self) -> None:
        ...
        self.after(COMPUTER_REPLY_DELAY_MS, lambda: self.controller.request_move(self.session.board))
